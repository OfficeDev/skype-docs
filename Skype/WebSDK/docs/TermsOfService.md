...
- You may use or test the functions of the pre-release software that has an X in the General Availability column listed on [https://aka.ms/SkypeWebSDKTerms](https://aka.ms/SkypeWebSDKTerms) in a live operating environment.
